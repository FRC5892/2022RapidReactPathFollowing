...
public class Drivetrain extends SubsystemBase {
	...
	private Encoder m_leftEncoder = new Encoder(0, 1, false, EncodingType.k4X);
	private Encoder m_rightEncoder = new Encoder(2, 3, false, EncodingType.k4X);

  private EncoderSim m_leftEncoderSim = new EncoderSim(m_leftEncoder);
  private EncoderSim m_rightEncoderSim = new EncoderSim(m_rightEncoder);

	private MotorControllerGroup m_leftMotors = new MotorControllerGroup(leftMotor1, leftMotor2, leftMotor3);
	private MotorControllerGroup m_rightMotors = new MotorControllerGroup(rightMotor1, rightMotor2, rightMotor3);
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("ENCODING SCALE", m_leftEncoder.getEncodingScale());
      }
